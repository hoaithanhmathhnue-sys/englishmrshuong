...
const DAILY_TEACHER_STUDENTS: VocabPhrase[] = [
  { 
    ...
    vietnamese: 'Các em đã hiểu bài chưa? -> Dạ chúng em hiểu rồi ạ / Dạ chưa ạ.',
  ...
  { 
    ...
    vietnamese: 'Em có thể lặp lại được không? -> Dạ được ạ.',
  ...
  { 
    ...
    vietnamese: 'Em có thể nói bằng Tiếng Anh được không?',
