...
export const DashboardTab: React.FC<DashboardTabProps> = ({
  ...
  return (
    <div className="space-y-7 pb-16">
      ...
      {/* ═══ HERO BANNER ═══ */}
      <div className="hero-banner-bg rounded-3xl overflow-hidden border border-amber-200/60 shadow-sm animate-fadeInUp">
        <div className="flex flex-col lg:flex-row">
          {/* Left: Main message */}
          <div className="flex-1 p-6 sm:p-8 lg:p-10 relative">
            {/* Decorative sunflowers */}
            <div className="absolute -left-4 -top-4 text-6xl opacity-20 select-none pointer-events-none animate-float-sunflower">🌻</div>
            <div className="absolute right-8 -bottom-2 text-5xl opacity-15 select-none pointer-events-none animate-float-sunflower-reverse">🌻</div>
            
            <div className="relative z-10 space-y-4">
              <h1 className="text-2xl sm:text-3xl lg:text-4xl font-black text-slate-900 leading-tight">
                <span className="text-amber-600">Nói tiếng Anh mỗi ngày</span><br/>
              ...
              <p className="text-xs sm:text-sm text-slate-600 max-w-md italic">
                "Small phrases – Big connections<br className="sm:hidden"/> for a brighter classroom!"
              </p>

              {/* Badge */}
              <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-amber-400/20 border border-amber-300 text-amber-800">
                <span className="text-lg">🌻</span>
                <span className="text-xs font-black">Better English · Brighter Future</span>
          ...
          {/* Right: Quote card */}
          <div className="lg:w-[320px] p-5 sm:p-6 lg:p-8 flex items-center">
            <div className="bg-white/90 rounded-2xl p-5 border border-amber-200/80 shadow-xs space-y-3 w-full">
              <div className="flex items-center gap-2">
                <div className="w-8 h-8 rounded-xl bg-amber-100 flex items-center justify-center text-lg">
                  🌻
                </div>
                <p className="text-xs font-bold text-amber-800">
                  Hôm nay, hãy tạo<br/>những khoảnh khắc tiếng Anh<br/>thật ý nghĩa nhé! 🌈
                </p>
              </div>
